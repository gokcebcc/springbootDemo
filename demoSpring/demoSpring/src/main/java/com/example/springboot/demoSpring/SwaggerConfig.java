package com.example.springboot.demoSpring;
...
@Configuration
    ...
    public class SwaggerConfig
    {
            ...
            public static final Contact DEFAULT_CONTACT = new Contact("Gokce", "http://www.gokcebicici.com", "libraryManagement");
            //configuring DEFAULT_API_INFO
            public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("SpringBoot/JPA/Hibernate/PostgreSQL Demo", "LibraryManagement Demo", "1.0", "urn:tos",
